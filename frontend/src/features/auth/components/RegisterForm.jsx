...
function RegisterForm({ handleRegister, handleGoogleLogin, loading, error }) {
  ...
  return (
    <div className="h-screen w-screen p-8 bg-black flex items-center justify-center ">
      {/* Main Container */}
      <div
        className="flex flex-col md:flex-row w-full max-h-[600px] max-w-[1000px] overflow-hidden"
        style={{
      ...
      >
        ...
        >
          ...
          <div className="mb-8">
            ...
            >
              Upload your resume, find your skill gaps, and get a personalized 4-week learning plan to land your next role.
            </p>
          </div>
          ...
          <div className="mt-8 text-[13px] text-[#888]">
            ...
            <Link className="text-[#f97316] hover:underline" to={"/login"}>
              Login
            </Link>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <p
              ...
              style={{ color: "#e8e8e0" }}
            >
              "ResumeIQ completely changed how I applied for jobs. It didn't just tell me my resume was weak—it gave me a day-by-day plan to learn exactly what I was missing. I landed three interviews the very next month."
            </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[12px] text-[#888]">
                  Junior Engineer, <span className="font-bold text-[#aaa]">TechNova</span>
                </span>
              </div>
            </div>
          </div>
